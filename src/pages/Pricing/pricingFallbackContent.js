export const pricingFallbackContent = {
  en: {
    homeSection: {
    ...
    hero: {
      ...
      subtitle: "Choose the right formation package for your business needs. No hidden fees, just straightforward value.",
  ...
  ar: {
    ...
    hero: {
      ...
      subtitle: "اختر الباقة المناسبة لاحتياجات شركتك. بدون رسوم مخفية، فقط قيمة واضحة وخطوات مفهومة.",
