export const defaultContactPageContent = {
  "en": {
    "hero": {
      ...
      "text": "Have questions about starting your U.S. business? Our experts are ready to guide you with clear answers and practical next steps.",
    ...
    "section": {
      ...
      "text": "Tell us what you need and our team will help you choose the right path for LLC formation, EIN assistance, banking guidance, or compliance support."
    },
    "info": {
  ...
  "ar": {
    "hero": {
      ...
      "text": "لديك أسئلة حول بدء عملك التجاري في الولايات المتحدة؟ فريقنا جاهز لمساعدتك بإجابات واضحة وخطوات عملية.",
      "primary": "أرسل رسالة",
    ...
    "section": {
      ...
      "text": "أخبرنا بما تحتاجه، وسنساعدك في اختيار المسار المناسب لتأسيس LLC، أو المساعدة في EIN، أو الإرشاد البنكي، أو دعم الامتثال."
    },
    "info": {
