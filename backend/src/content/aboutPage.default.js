  ...
  "en": {
    ...
    "visuals": {
      "mission": {
        ...
        "einRequest": "EIN request",
        "bankingGuide": "Banking guide"
      },
      "vision": {
        "borderless": "Borderless",
        "businessAccess": "U.S. business access"
      }
    },
    "introStats": [
      {
    ...
    "testimonials": {
      ...
      "items": [
        {
          "quote": "RITA DIGITAL made forming my Wyoming LLC incredibly easy. The banking solution was a lifesaver for our SaaS product.",
          "name": "Lars O.",
          "company": "TechNova",
          "initials": "L"
        },
        {
          "quote": "The best investment for my business. I got my EIN without an SSN faster than expected.",
          "name": "Fatima Z.",
          "company": "E-Commerce Global",
          "initials": "F"
        },
        {
          "quote": "Compliance used to keep me up at night. Now I leave it entirely to their expert team.",
          "name": "Diego R.",
  ...
  "ar": {
    ...
    "visuals": {
      "mission": {
        ...
        "einRequest": "طلب EIN",
        "bankingGuide": "الإرشاد البنكي"
      },
      "vision": {
        "borderless": "بلا حدود",
        "businessAccess": "الوصول إلى الأعمال الأمريكية"
      }
    },
    "introStats": [
      {
      ...
      "groups": [
        {
          ...
          "items": [
            {
              "q": "هل أحتاج أن أكون مواطنًا أمريكيًا لتأسيس LLC؟",
              "a": "لا. تساعد RITA DIGITAL SERVICES غير المقيمين في أمريكا على تجهيز وإدارة عملية التأسيس عن بعد."
            },
            {
              "q": "لماذا تنصحون بـ Wyoming أو New Mexico؟",
              "a": "غالبًا ما يختارها المؤسسون الدوليون بسبب سهولة الإدارة والخصوصية وتكاليف الإيداع العملية."
            },
            {
              "q": "كم يستغرق تأسيس LLC؟",
              "a": "تختلف المدة حسب الولاية وحجم الطلبات، لكن مسارنا مصمم لتنظيم الوثائق والتحديثات والخطوات التالية بوضوح."
            },
            {
              "q": "هل أحتاج عنوانًا فعليًا في أمريكا؟",
              "a": "يحتاج أغلب المؤسسين إلى وكيل مسجل وحل بريد تجاري موثوق. نساعدك على فهم الخيارات المناسبة لحالتك."
            },
            {
              "q": "ما هو الوكيل المسجل؟",
              "a": "الوكيل المسجل هو جهة الاتصال الرسمية التي تستقبل الوثائق القانونية ووثائق الولاية الخاصة بشركتك."
            }
          ]
        },
        {
          ...
          "items": [
            {
              "q": "ما هو EIN؟",
              "a": "هو رقم تعريف صاحب العمل ويستخدم لتعريف الشركة لأغراض الضرائب والبنوك في أمريكا."
            },
            {
              "q": "هل يمكنني الحصول على EIN بدون SSN أو ITIN؟",
              "a": "يمكن للعديد من المؤسسين غير المقيمين التقديم بدون SSN أو ITIN. نساعدك على تجهيز الطلب وتتبع العملية."
            },
            {
              "q": "كم يستغرق الحصول على EIN؟",
              "a": "تختلف المدة حسب طريقة التقديم وحجم المعالجة، ونبقيك على اطلاع أثناء تقدم الطلب."
            },
            {
              "q": "هل تنتهي صلاحية EIN؟",
              "a": "غالبًا يبقى EIN مرتبطًا بالشركة بعد إصداره، لكن يجب تحديث سجلات الشركة والامتثال باستمرار."
            }
          ]
        },
        {
          ...
          "items": [
            {
              "q": "هل أحتاج للسفر إلى أمريكا لفتح حساب بنكي؟",
              "a": "العديد من المزودين الحديثين يدعمون الطلبات عن بعد للشركات المؤهلة. نرشدك للخيارات المناسبة وتجهيز الوثائق."
            },
            {
              "q": "هل يمكنني استخدام Stripe وPayPal مع حسابي؟",
              "a": "نساعدك على تجهيز إعداد شركتك لمزودي الدفع وأدوات التجارة الإلكترونية."
            },
            {
              "q": "هل أموالي آمنة؟",
              "a": "نرشد العملاء نحو مزودين ماليين معروفين ونساعدهم على فهم المعلومات المطلوبة من كل مزود."
            },
            {
              "q": "ما هي الوثائق المطلوبة؟",
              "a": "تختلف المتطلبات، لكنها غالبًا تشمل وثائق التأسيس، تأكيد EIN، معلومات الملكية، ووثائق الهوية."
            }
          ]
        },
        {
          ...
          "items": [
            {
              "q": "هل يجب علي دفع ضرائب أمريكية؟",
              "a": "تعتمد الالتزامات الضريبية على هيكل الشركة والنشاط وبلد الإقامة. نساعدك على تنظيم جانب الأعمال وتوجيهك للدعم الضريبي المؤهل عند الحاجة."
            },
            {
              "q": "ما هو تقرير BOI؟",
              "a": "يشير إلى تقرير معلومات الملكية المستفيدة. قد تتغير المتطلبات، لذلك نساعد العملاء على البقاء منظمين حول تحديثات الامتثال."
            },
            {
              "q": "ما هي التقارير السنوية؟",
              "a": "بعض الولايات تتطلب تقارير أو تجديدات دورية للحفاظ على وضع الشركة الجيد."
            },
            {
              "q": "ماذا يحدث إذا فاتني موعد امتثال؟",
              "a": "قد يؤدي تفويت المواعيد إلى رسوم أو فقدان الوضع الجيد للشركة. تذكيرات الامتثال لدينا مصممة لتقليل هذا الخطر."
            }
          ]
        }
      ]
