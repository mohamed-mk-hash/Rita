export const defaultHomePageContent = {
  "en": {
    "hero": {
      ...
      "title": "Launch your US company and get ready to receive payments worldwide.",
      "subtitle": "Rita helps non-US residents form a US LLC, prepare EIN documents, and get guided banking and payment options — with every step tracked online.",
      ...
      "visualSubtitle": "Four simple stages, managed through Rita instead of scattered WhatsApp messages, emails, and confusing forms.",
      "visualItems": [
        "Form the US LLC",
      ...
      "trust": "The visitor should understand this in the first 5 seconds: Rita turns a local founder into a globally ready US business."
    },
    "product": {
    ...
    "trust": {
      "quote": "“Rita Digital Services helps non-US residents worldwide establish, operate, and manage their US business with confidence.”",
  ...
  "ar": {
    "hero": {
      ...
      "subtitle": "تساعد Rita غير المقيمين في أمريكا على تأسيس LLC، تجهيز وثائق EIN، واختيار حلول بنكية وبوابات دفع مناسبة — مع تتبع كل خطوة أونلاين.",
      ...
      "visualSubtitle": "أربع مراحل بسيطة تديرها Rita بدل التشتت بين واتساب، الإيميل، والملفات المتفرقة.",
      "visualItems": [
        "تأسيس LLC الأمريكية",
      ...
      "trust": "يجب أن يفهم الزائر خلال أول 5 ثوانٍ: Rita تحوّل صاحب مشروع محلي إلى شركة أمريكية جاهزة للعالم."
    },
    "product": {
    ...
    "trust": {
      "quote": "“تساعد Rita Digital Services غير المقيمين في أمريكا على تأسيس وتشغيل وإدارة أعمالهم الأمريكية بثقة.”",
      "name": "Rita Digital Services",
